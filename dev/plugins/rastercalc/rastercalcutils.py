...
def rasterExtent(): #note how does this relate to each rasterlayer in qgis
	iface = qgis.utils.iface
	m = iface.mapCanvas()
	l = m.layers()
	e_list = []
	for layer in l: #make sure no vector layers
		e = layer.extent()
		dim = (e.width(),e.height())
		e_list.append(dim) #hopefully should work
	return e_list
